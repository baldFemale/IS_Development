...
class Merchant(models.Model):
    ...
    IdentityNum = models.CharField(max_length=18, validators=MinLengthValidator(20))
...
class Restaurant(models.Model):
    ...
    LicenseID = models.CharField(validators=RegexValidator(regex=r'^[0-9]*$', inverse_match=True))
